...
const Card = (props: Props) => {
  return (
    <div className="pb-2 pr-2 hover:translate-y-1 ">
      <div className={`  max-w-sm h-fit break-inside flex flex-1 flex-col justify-between drop-shadow-hard border-4 border border-gray-900 rounded-xl  dark:bg-gray-800 dark:border-gray-700 " + ${props.bg_color}`}>
        <div>
