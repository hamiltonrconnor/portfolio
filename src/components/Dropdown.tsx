...
const Dropdown = ({ updateFilter }: Props) => {
  ...
  return (
    <div>
      <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className="text-white bg-blue-700  border-3 border-gray-900 rounded-lg  hover:bg-blue-800  font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 " type="button" onClick={handleHidden}>Filters <svg className="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4" />
      </svg></button>

      <div id="dropdown" className={hidden ? "hidden" : "" + "z-10  bg-cream border-3 border-gray-900 rounded-lg drop-shadow-hard divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700"}>
